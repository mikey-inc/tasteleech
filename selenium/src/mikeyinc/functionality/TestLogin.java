...
public class TestLogin {
	...
	public void soundcloudLogin(WebDriver driver){
		
		String testTitle = "Checking login with soundcloud and fetching of liked songs.";
		...
		for (String handle : driver.getWindowHandles()) {
		    ...
		    if(someTitle.equalsIgnoreCase("Authorize access to your account on SoundCloud - Create, record and share your sounds for free")){
		    	...
		    	driver.findElement(By.id("username")).sendKeys("ranjitCatchinUp");
		    	driver.findElement(By.id("password")).clear();
		    	driver.findElement(By.id("password")).sendKeys("ran@soundcloud");
		...
		for (String handle : driver.getWindowHandles()) {
		    ...
		    if(someTitle.equalsIgnoreCase("Tasteleech")){		    	
				...
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//table[@id='prefList']/tbody/tr[2]")));
		    	//Globals.waitForSeconds(20);
		    	int rowCount=driver.findElements(By.xpath("//table[@id='prefList']/tbody/tr")).size();		
